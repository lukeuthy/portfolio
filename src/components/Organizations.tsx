...
const organizations: Org[] = [
  ...
  { name: "API",   role: "Creative Team Member", description: "Association of Proactive Innovators. Driving innovation through hackathons, design sprints, and interdisciplinary projects that bridge technology and creativity.",            url: "http://api-mmcm.org/",                logo: "API",  accentColor: "#a78bfa", type: "Tech Community", bgPattern: "radial-gradient(circle at 80% 20%, rgba(167,139,250,0.12) 0%, transparent 60%)" },
];
