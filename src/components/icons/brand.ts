...
// Brand marks not shipped by lucide (removed for trademark reasons).
function brand(path: string): FunctionalComponent<IconProps> {
...
/** Resolve a social IconKey to its renderable component. */
export const socialIcon: Record<IconKey, FunctionalComponent<IconProps>> = {
  github: GithubIcon,
  linkedin: LinkedinIcon,
  x: XIcon,
  mail: Mail as unknown as FunctionalComponent<IconProps>,
}
